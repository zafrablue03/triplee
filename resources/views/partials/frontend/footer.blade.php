<footer class="footer">
    <div class="container">
        ...
        <div class="col-md-4">
            <span class="copyright">Copyright &copy; Triple E</span>
            <span class="copyright">by @fingersandmind</span>
        </div>
        <div class="col-md-4">
    ...
    <div class="modal-dialog">
        ...
        <div class="container">
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <img class="img-fluid d-block mx-auto" src="{{ asset('assets/frontend/img/portfolio/01-full.jpg') }}" alt="">
